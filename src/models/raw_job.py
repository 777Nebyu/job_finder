...
class RawJobPosting(BaseModel):
    ...
    """
    source: str = Field(..., description="Scraper identifier, e.g., 'ethiojobs', 'remoteok', 'telegram_channels'")
    ...
    posted_date_raw: Optional[str] = Field(default=None, description="Raw publication date string")
    deadline_raw: Optional[str] = Field(default=None, description="Raw application deadline date string")
